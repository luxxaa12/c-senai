...
int main (){
	...
	/*ENQUANTO (WHILE) A COMPARAÇAO (STRCMP) LOGINUSUARIO,LOGINCADASTRADO FOR IGUAL A 0 OU ENQUANTO A COMPARAÇAO SENHAUSUARIO,SENHACADASTRADA FOR IGUAL
	A 0 SEGUE ADIANTE SE ALGUNS DOS DOIS FOREM FALSOS REPETE*/
